...
function PinDetail({ params }) {
  ...
  const [isRounded, setIsRounded] = useState(true); // Set this based on your logic
  ...
  const getPinDetail = async () => {
    ...
    if (docSnap.exists()) {
      ...
      // Here you can set your condition to decide if the image should be rounded
      setIsRounded(true); // Or false based on your condition
    } else {
            ...
            <div className="mx-auto max-w-5xl">
              <div className="grid grid-cols-1 lg:grid-cols-2 shadow-[0_10px_20px_rgba(0,0,0,0.5)] rounded-2xl lg:min-h-[500px] ">
                <div className="m-auto ">
                  <PinImage
                    pinDetail={pinDetail || { image: pinDetail.urls?.regular }}
                    isRounded={isRounded}
